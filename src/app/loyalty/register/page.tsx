              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-black/5 border border-border/60 p-6 sm:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button type="submit" disabled={loading || !phone || !name}
                    className="w-full py-3.5 bg-gradient-to-r from-accent to-primary text-white font-bold rounded-xl text-sm hover:opacity-90 disabled:opacity-40 transition-all flex items-center justify-center gap-2 shadow-lg shadow-accent/20">
