  ...
  const handleReturn = async () => {
    ...
    try {
      ...
      if (returnType === "exchange") {
        router.push(`/sales?returnDiscount=${totalReturnValue}&returnCustomer=${encodeURIComponent(sale.customer?.name || "")}&returnPhone=${encodeURIComponent(sale.customer?.phone || "")}`);
      } else {
